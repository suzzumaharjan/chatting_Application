<?php
  ...
  if($_POST)
  {
     ...
     $sql="insert into tbl_admins (full_name,password)values('$fullname','$encryptedpswd')";
     if (mysqli_query($conn,$sql))
     {
       header('Location: http://localhost/chatting/adminfetch.php');
       }
  ...
  <body>
    ...
    <table >
        ...
        <tr>
            ...
            <td>
                <a href="http://localhost/chatting/admin_update.php?id=<?=$admin['id']?>"><i class="fas fa-upload"></i></a>
            </td>
            <td>
                <a href="http://localhost/chatting/admin_delete.php?id=<?=$admin['id']?>"><i class="fas fa-envelope-open-text"></i></a>
            </td>
        </tr>
        <?php } ?>
    </table>
